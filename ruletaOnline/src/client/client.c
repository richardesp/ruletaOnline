...
void imprimirAyuda(void)
{
    ...
    fprintf(stdout, "REGISTER  –u  usuario  –p  password:  mensaje  mediante  el  cual  el  usuario  solicita registrarse para acceder al juego de la ruleta que escucha en el puerto TCP  2050.\n");
    fprintf(stdout, "INICIAR_PARTIDA: mensaje para solicitar jugar una partida de la ruleta de la suerte en grupo. \n");
